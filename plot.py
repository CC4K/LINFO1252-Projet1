...
# Plot
fig1 = plt.figure()
plt.errorbar(X, Mean_philo, yerr=StDev_philo, linestyle="solid", linewidth=0.5, ecolor="red", elinewidth=2.5, capsize=20, markersize=8, fmt="o")
plt.xlim(1, 6)
...
fig2 = plt.figure()
plt.errorbar(X, Mean_prod_conso, yerr=StDev_prod_conso, linestyle="solid", linewidth=0.5, ecolor="red", elinewidth=2.5, capsize=20, markersize=8, fmt="o")
plt.xlim(1, 6)
plt.xticks(np.arange(7), [1, 2, 4, 8, 16, 32, 64])
plt.xlabel('Nombre de threads')
...
fig3 = plt.figure()
plt.errorbar(X, Mean_read_write, yerr=StDev_read_write, linestyle="solid", linewidth=0.5, ecolor="red", elinewidth=2.5, capsize=20, markersize=8, fmt="o")
plt.xlim(1, 6)
plt.xticks(np.arange(7), [1, 2, 4, 8, 16, 32, 64])
plt.xlabel('Nombre de threads')
plt.ylim(0, 0.1)
...
plt.grid(True)
plt.savefig("lecteurs_ecrivains_performances.png", dpi=1000)
# plt.show()
